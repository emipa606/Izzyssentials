...
namespace Izzyssentials
{
    public class Graphic_ColorWall : Graphic //17/07/16-R
    {
        ...
        public override void Init(GraphicRequest req)
        {
            ...
            //subGraphics = new Graphic[Enum.GetNames(typeof(StuffAppearanceDef)).Length];
            ...
            //var enumerator = Enum.GetValues(typeof(StuffAppearanceDefOf)).GetEnumerator();
            var counter = 0;
            foreach (var stuffAppearance in allStuffAppearanceDefs)
            {
                ...
                //{
                //var stuffAppearance = (StuffAppearanceDef) enumerator.Current;
        ...
        {
            return string.Concat("Appearance(path=", path, ", color=", color, ", colorTwo", colorTwo);
        }
    }
}